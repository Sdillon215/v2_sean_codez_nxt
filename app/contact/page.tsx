...
export default function Page() {
  ...
  return <div className="grid h-screen gap-1 opacity-70 rounded-xl place-content-center text-center content-center place-items-center p-8">
      ...
      <h4 className="text-1xl md:text-2xl font-bold w-full md:w-2/3">If you're interested in working together please feel free to reach out through LinkedIn!</h4>
